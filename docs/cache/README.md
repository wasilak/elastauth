...
- **[Memory Cache](memory.md)** - In-memory caching for single-instance deployments
- **[Redis Cache](redis.md)** - Distributed caching for multi-instance deployments  
- **[File Cache](file.md)** - File-based persistent caching
- **[No Cache](disabled.md)** - Direct Elasticsearch calls on every request
...
- [Memory Cache](memory.md) - In-memory caching configuration
- [Redis Cache](redis.md) - Distributed caching setup
- [File Cache](file.md) - File-based caching options
