...
- **[Authelia](authelia.md)** - Header-based authentication for Authelia deployments
- **[OAuth2/OIDC](oidc.md)** - Generic OAuth2/OIDC provider supporting multiple systems
...
- [OAuth2/OIDC Provider](oidc.md) - JWT token authentication
