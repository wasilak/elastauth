...
- **[OAuth2/OIDC](/elastauth/providers/oidc)** - For Keycloak, Authentik, Auth0, Azure AD, and other OIDC providers
...
- **[OAuth2/OIDC](/elastauth/providers/oidc)**: Generic OAuth2/OIDC support for:
  ...
  - Auth0
  - Azure AD
  - And many more OIDC-compliant providers...
...
```mermaid
graph LR
    Client[Client] --> Traefik1[Traefik]
...
[Learn more about Authentication-Only Mode →](/elastauth/deployment/auth-only-mode)
...
[Learn more about Transparent Proxy Mode →](/elastauth/deployment/proxy-mode)
...
[Compare Operating Modes →](/elastauth/deployment/modes)
