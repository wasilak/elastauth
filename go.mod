...
require go.opentelemetry.io/otel/exporters/stdout/stdoutlog v0.10.0 // indirect
...
require (
	...
	go.opentelemetry.io/proto/otlp v1.5.0 // indirect; indirecgo.opentelemetry.io/otel/logt
